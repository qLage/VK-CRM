...
const addKpiFinanceColumns = require('../migrations/add_kpi_finance_columns');
...
async function migrate() {
  ...
  try {
    ...
    if (isPostgres) {
      ...
      await ensureUnique('quarterly_plans', 'quarterly_plans_period_year_period_quarter_key', 'period_year, period_quarter');
