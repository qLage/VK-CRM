...
export interface DealTableRow {
  ...
  mop_id?: string;
  rop_id?: string;
  /** Employee credited for mortgage on this deal (МОП, РОП, or broker); optional */
  mortgage_credited_id?: string;
  /** Subcontractor (сдельщик) — partner agent who receives a share */
